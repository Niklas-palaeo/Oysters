...
(Fig2atop/Fig2abelow+plot_layout(heights = c(1,9)))|(Fig2btop/Fig2bbelow+plot_layout(heights = c(1,9)))|(Fig2ctop/Fig2cbelow+plot_layout(heights = c(1,9)))+plot_annotation(tag_levels = "A")
...
ggsave(plot = p,filename = here("Plots","Figure3_B.png"),width = 9,height = 8)
